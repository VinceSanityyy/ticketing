                   ...
                   <div class="row">
                      <div class="col-md-4 mb-3 mb-md-0">
                         ...
                         <ul class="payments-types">
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{asset('layout/images/payment/visa.png')}}" alt="visa" title="Visa"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{asset('layout/images/payment/discover.png')}}" alt="discover" title="Discover"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{asset('layout/images/payment/paypal.png')}}" alt="paypal" title="PayPal"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{asset('layout/images/payment/american.png')}}" alt="american express" title="American Express"></a></li>
                            <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{asset('layout/images/payment/mastercard.png')}}" alt="discover" title="Discover"></a></li>
                         </ul>
                      </div>
                      <div class="col-md-4 mb-3 mb-md-0">
                         <p>Subscribe</p>
                ...
                <div class="container">
                   <div class="footer-copyright">
                      <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item" id="demo"> <a class="nav-link" >Terms of Use</a> </li>
                         <li class="nav-item"> <a class="nav-link" href="#">Privacy Policy</a> </li>
                      </ul>
                      <p class="copyright-text">Copyright © 2019 <a href="#">ORO Airways</a>. All Rights Reserved.</p>
                      <button  class="btn btn-info" style="visibility: hidden;" id="hidden"><img src="{{asset('image/bank.png')}}" height="25" style="padding-right:8px;"><font color="gold">ORO</font> <small>Click</small></button><br>
...
if (button.disabled) {
myWindow.close();
myWindow=window.open("/termsofuse", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=400,height=400 ,top=" + top + ", left=" + left);
} else {
myWindow=window.open("/termsofuse", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=400,height=400 ,top=" + top + ", left=" + left);
}
